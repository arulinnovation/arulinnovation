...
export const gridItems = [
  ...
  //   imgClassName: "",
  //   titleClassName: "justify-center  text-light-blue",
  //   img: "./grid.svg",
  //   spareImg: "./b4.svg",
  // },
  // {
  ...
  {
    id: 6,
    title: "Automate your success with next-gen tech — Contact Us today!",
    description: "",
...
{
    id: 4,
    title: "professional after-sales support, preventive maintenance, and technical service to keep your production seamless.",  //WHY CHOOSE US?
    description: "",
    className: "lg:col-span-2 md:col-span-2 md:row-span-3",
    imgClassName: "",
    titleClassName: "justify-start",
...
export const workExperience = [
  {
    id: 1,
    title: " SENTHIL G ",
    title2: "Proprietor - Automation",
    desc: "30 Years   Experience in Industrial Automation, Special Purpose Machines , Jig & Fixture.",
    className: "md:col-span-2",
    // thumbnail: "./senthil_profile.jpg",
  },
];
