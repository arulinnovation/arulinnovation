  ...
  return (
    <div className="flex flex-col items-center justify-center absolute inset-0">
      ...
      >
        {/* Added Title */}
        <h1
          className="text-center text-2xl md:text-3xl font-bold mb-4 bg-gradient-to-r from-white to-pink-200 bg-clip-text text-transparent"
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, transparent, rgba(4, 7, 29, 0.8))",
        }}
      />
    </div>
  );
